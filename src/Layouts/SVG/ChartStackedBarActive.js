...
const ChartStackedBarActive = (props) => {
    return (
        <svg style={{ fill: 'rgb(255,255,255)' }} class="icon waveChartIcon" name="chart-thumb-stackhbar" viewBox="0 0 100 100">
...
export default ChartStackedBarActive;