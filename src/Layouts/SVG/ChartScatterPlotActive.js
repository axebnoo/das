...
const ChartScatterPlotActive = (props) => {
    return (
        <svg style={{ fill: 'rgb(255, 255, 255)' }} class="icon waveChartIcon" name="chart-thumb-scatter" viewBox="0 0 100 100">
...
export default ChartScatterPlotActive;