...
const ChartFunnelActive = (props) => {
    return (
        <svg style={{ fill: 'rgb(255, 255, 255)' }} class="icon waveChartIcon" name="chart-thumb-funnel" viewBox="0 0 100 100">
...
export default ChartFunnelActive;